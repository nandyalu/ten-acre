...
2. **News and sentiment sources for the analysis.** The pipeline says Hold most of the time, and the agent can only act on what the analysts say. CLAUDE.md names the fix: resolve the ticker to a company name once, then fetch real news. This is submodule work.
...
4. **The watchlist ageing rule.** Nine names of thirty. Not pressing.
